...
struct GroupGame {
    ...
    init(snapshot: FIRDataSnapshot) {
        ...
        rounds = snapshotValue?["rounds"] as? String ?? ""

        player1Id = snapshotValue?["player1Id"] as? String ?? ""
        player1Name = snapshotValue?["player1Name"] as? String ?? ""
        player1Pic = snapshotValue?["player1Pic"] as? String ?? ""
        player1Rounds = snapshotValue?["player1Rounds"] as? String ?? ""
        player1Points = snapshotValue?["player1Points"] as? String ?? ""
        
        player2Id = snapshotValue?["player2Id"] as? String ?? ""
        player2Name = snapshotValue?["player2Name"] as? String ?? ""
        player2Pic = snapshotValue?["player2Pic"] as? String ?? ""
        player2Rounds = snapshotValue?["player2Rounds"] as? String ?? ""
        player2Points = snapshotValue?["player2Points"] as? String ?? ""
        
        player3Id = snapshotValue?["player3Id"] as? String ?? ""
        player3Name = snapshotValue?["player3Name"] as? String ?? ""
        player3Pic = snapshotValue?["player3Pic"] as? String ?? ""
        player3Rounds = snapshotValue?["player3Rounds"] as? String ?? ""
        player3Points = snapshotValue?["player3Points"] as? String ?? ""
        
        player4Id = snapshotValue?["player4Id"] as? String ?? ""
        player4Name = snapshotValue?["player4Name"] as? String ?? ""
        player4Pic = snapshotValue?["player4Pic"] as? String ?? ""
        player4Rounds = snapshotValue?["player4Rounds"] as? String ?? ""
        player4Points = snapshotValue?["player4Points"] as? String ?? ""
        
        }
    
    func serialize() -> [String:Any] {
        
        return  ["id": id, "date": date, "status": status, "title": title, "rounds": rounds, "player1Id": player1Id, "player1Name": player1Name, "player1Pic": player1Pic, "player1Roudns": player1Rounds, "player1Points": player1Points, "player2Id": player2Id, "player2Name": player2Name, "player2Pic": player2Pic, "player2Rounds": player2Rounds,"player2Points": player2Points, "player3Id": player3Id, "player3Name": player3Name, "player3Pic": player3Pic, "player3Roudns": player3Rounds, "player3Points": player3Points, "player4Id": player4Id, "player4Name": player4Name, "player4Pic": player4Pic, "player4Roudns": player4Rounds, "player4Points": player4Points]
    }
